...
print(consistent_high_producers)
```
```{r}
...
ggplot(recent_data,
  ...
  geom_line() +
  labs(title = "Rice Production Over the Last Five Years", x = "Year", y = "Production (in tons)") +
  theme_minimal() +
  theme(legend.position = "none")
...
ggplot(improvement_data,
  ...
  coord_flip() +
  labs(title = "Improvement in Rice Production Over the Last Five Years", x = "Country", y = "Change in Production (in tons)") +
  theme_minimal()
