...
rice_trade %>%
  ...
  ggplot(aes(x = Year)) +
  geom_line(aes(y = `Imports(t)`), color = "steelblue") +
  geom_line(aes(y = `Exports(t)`), color = "darkred") +
  labs(title = "Global Rice Import (Blue) vs Export (Red) Over Time",
       x = "Year",
       y = "Amount (tons)") +
  theme_minimal() +
...
top_rice_trade %>%
  ...
  coord_flip() +
  labs(title = "Top 5 Importers Since 1980",
       x = "Country",
       y = "Imports (t)") +
  theme_minimal() +
...
top_rice_trade %>%
  ...
  geom_line() +
  labs(title = "Import Trends Over Time for Top 5 Importers",
       x = "Country",
       y = "Imports (t)") +
  theme_minimal() +
  scale_y_continuous(labels = scales::comma) +
  scale_color_manual(values = c("blue", "orange", "magenta", "yellow", "green"))
...
top_rice_trade %>%
  ...
  geom_line() +
  labs(title = "Export Trends Over Time for Top 5 Exporters",
       x = "Country",
       y = "Exports (t)") +
  theme_minimal() +
  scale_y_continuous(labels = scales::comma) +
