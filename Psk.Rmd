...
```
```{r chi}
#Chi-Square test for average supply chain waste and total food waste

average_supply_chain_waste <- data.frame(
  Country = c("China", "India", "Vietnam", "Indonesia", "Thailand", "Bangladesh", "Myanmar"),
  Average_Supply_Chain_Waste = c(7448683, 2873244, 2849080, 2623317, 1406286, 1334844, 938625)
)

total_food_waste <- data.frame(
  Country = c("China", "India", "Indonesia", "Thailand", "Vietnam", "Bangladesh", "Myanmar"),
  Total_Food_Waste = c(1613301920, 1277946270, 327764644, 297933622, 259794292, 165710250, 66361258)
)
